## robot_localization (rolling) - 3.10.0-2

The packages in the `robot_localization` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -t rolling -r rolling robot_localization --edit` on `Fri, 29 Aug 2025 14:45:26 -0000`
...
## robot_localization (rolling) - 3.10.0-1

The packages in the `robot_localization` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -t rolling -r rolling robot_localization --edit` on `Fri, 29 Aug 2025 14:43:03 -0000`
...
## robot_localization (kilted) - 3.9.4-1

The packages in the `robot_localization` repository were released into the `kilted` distro by running `/usr/bin/bloom-release -t kilted -r kilted robot_localization --edit` on `Fri, 29 Aug 2025 14:37:54 -0000`
...
## robot_localization (humble) - 3.5.4-1

The packages in the `robot_localization` repository were released into the `humble` distro by running `/usr/bin/bloom-release -t humble -r humble robot_localization` on `Fri, 29 Aug 2025 14:33:15 -0000`
...
## robot_localization (jazzy) - 3.8.3-1

The packages in the `robot_localization` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release -t jazzy -r jazzy robot_localization` on `Fri, 29 Aug 2025 14:28:37 -0000`
...
## robot_localization (kilted) - 3.9.3-1

The packages in the `robot_localization` repository were released into the `kilted` distro by running `/usr/bin/bloom-release robot_localization --rosdistro kilted --track kilted --edit` on `Thu, 29 May 2025 22:14:37 -0000`
...
## robot_localization (rolling) - 3.9.3-1

The packages in the `robot_localization` repository were released into the `rolling` distro by running `/home/automatom/bloom_venv/bin/bloom-release -t rolling -r rolling robot_localization` on `Mon, 19 May 2025 08:12:00 -0000`
...
## robot_localization (rolling) - 3.9.2-2

The packages in the `robot_localization` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -t rolling -r rolling robot_localization` on `Fri, 21 Mar 2025 16:59:28 -0000`
...
## robot_localization (rolling) - 3.9.2-1

The packages in the `robot_localization` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -t rolling -r rolling robot_localization` on `Fri, 21 Mar 2025 16:56:40 -0000`
...
The packages in the `robot_localization` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release -t jazzy -r jazzy robot_localization` on `Fri, 21 Mar 2025 16:51:49 -0000`
...
## robot_localization (iron) - 3.7.1-1

The packages in the `robot_localization` repository were released into the `iron` distro by running `/usr/bin/bloom-release -t iron -r iron robot_localization` on `Thu, 29 Aug 2024 09:04:35 -0000`
...
The packages in the `robot_localization` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release -t jazzy -r jazzy robot_localization` on `Thu, 29 Aug 2024 09:01:09 -0000`
...
## robot_localization (rolling) - 3.9.1-1

The packages in the `robot_localization` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -t rolling -r rolling robot_localization` on `Thu, 29 Aug 2024 08:33:17 -0000`
